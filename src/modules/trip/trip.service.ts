      ...
      friends: [
        {
          id: 1,
          featureImages: [
            'https://congcu.org/tiny/travel/friends/5.jpg',
            'https://congcu.org/tiny/travel/friends/6.jpg',
          ],
        ...
        },
        {
          id: 2,
          featureImages: [
            'https://congcu.org/tiny/travel/friends/1.jpg',
            'https://congcu.org/tiny/travel/friends/2.jpg',
          ],
          location: 'Hà Nội, Việt Nam',
          name: 'Tùng Đỗ',
          bio: 'Tuổi trẻ là những chuyến đi dài',
          age: 24,
          favorites: ['Camping', 'Moutain', 'Phượt', 'beach'],
        },
        {
          id: 3,
          featureImages: [
            'https://congcu.org/tiny/travel/friends/3.jpg',
            'https://congcu.org/tiny/travel/friends/4.jpg',
          ],
          location: 'Đà Nẵng, Việt Nam',
          name: 'Hoàng Bùi',
          bio: 'Không gì là không thể!',
          age: 35,
          favorites: ['Beach', 'relaxing', 'moutain'],
        },
      ],
      guide: [
        {
          id: 1,
          featureImages: [
            'https://congcu.org/tiny/travel/guides/1.jpg',
            'https://congcu.org/tiny/travel/guides/2.jpg',
          ],
          location: 'Thái Nguyên, Việt Nam',
          name: 'Linh Tô',
          bio: 'YOLO',
          age: 22,
          favorites: ['Beach', 'Phượt', 'Moutain'],
        },
        {
          id: 2,
          featureImages: [
            'https://congcu.org/tiny/travel/guides/3.jpg',
            'https://congcu.org/tiny/travel/guides/4.jpg',
          ],
          location: 'Thái Nguyên, Việt Nam',
          name: 'Huy Đinh',
          bio: 'Life is too short for long-term grudges',
          age: 27,
          favorites: ['Moutain', 'Beach'],
        },
        {
          id: 3,
          featureImages: [
            'https://congcu.org/tiny/travel/guides/5.jpg',
            'https://congcu.org/tiny/travel/guides/6.jpg',
          ],
          location: 'Hồ Chí Minh, Việt Nam',
          name: 'Thành Nguyễn',
          bio: 'Sống một đời an nhiên',
          age: 33,
          favorites: ['Relaxing', 'Beach'],
        },
      ],
      shop: [
        {
          name: 'Giày Adidas Hiking',
          featureImages: [
            'https://congcu.org/tiny/travel/shops/1.jpeg',
            'https://congcu.org/tiny/travel/shops/2.jpeg',
          ],
          rate: 5,
          sold: 68,
          price: '1.345.999 đ',
        },
        {
          name: 'Balo Osprey ',
          featureImages: [
            'https://congcu.org/tiny/travel/shops/5.jpeg',
            'https://congcu.org/tiny/travel/shops/6.jpeg',
          ],
          rate: 4,
          sold: 170,
          price: '1.345.999 đ',
        ...
        {
          name: 'Áo gió Columbia',
          featureImages: [
            'https://congcu.org/tiny/travel/shops/3.jpeg',
            'https://congcu.org/tiny/travel/shops/4.jpeg',
          ],
          rate: 3,
          sold: 100,
          price: '1.945.999 đ',
        },
        {
          name: 'Túi ngủ VAUDE',
          featureImages: [
            'https://congcu.org/tiny/travel/shops/7.jpeg',
            'https://congcu.org/tiny/travel/shops/8.jpeg',
          ],
          rate: 4,
          sold: 49,
          price: '1.799.999 đ',
